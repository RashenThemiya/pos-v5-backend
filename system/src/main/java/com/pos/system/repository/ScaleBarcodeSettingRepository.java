...
public interface ScaleBarcodeSettingRepository extends JpaRepository<ScaleBarcodeSetting, Long> {
    ...
    List<ScaleBarcodeSetting> findByBranchId(Long branchId);
    List<ScaleBarcodeSetting> findByBranchIdAndIsActiveTrue(Long branchId);
    boolean existsByBranchIdAndPrefix(Long branchId, String prefix);
}
